...
namespace BusinessTier
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            host = new ServiceHost(typeof(AccountBusinessInterfaceImplimentation));
            ...
            host.AddServiceEndpoint(typeof(AccountBusinessInterface), tcp, "net.tcp://0.0.0.0:8200/BusinessService");
